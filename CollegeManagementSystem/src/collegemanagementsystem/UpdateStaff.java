...
class UpdateStaff implements ActionListener{

    JFrame f;
    JLabel lupdate,lnew,lname,luser,lid,ldob,laddr,lph,lemail,ldesignation;
    JTextField ttempid,tname,tuser,tid,tdob,taddr,tph,temail,tdesignation;
    JButton b,b1,b2;
    ...
    UpdateStaff(){
        ...
        JLabel llempid = new JLabel("Enter employee id to update the data of staff");
        ...
        lupdate = new JLabel("Update Staff Details:");
        ...
        ldesignation.setBounds(400,320,130,30);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource()==b){
            try{
                conn c13 = new conn();
                String str1 = "update staff set name='"+tname.getText()+"',username='"+tuser.getText()+"',dob='"+tdob.getText()+"',address='"+taddr.getText()+"',contactno='"+tph.getText()+"',email='"+temail.getText()+"',designation='"+tdesignation.getText()+"' where empid = '"+ttempid.getText()+"';";
                PreparedStatement st = c13.c.prepareStatement(str1);
        ...
        if(ae.getSource() == b2){
            try{
                conn c14 = new conn();
                String str2 = "select * from staff where empid = '"+ttempid.getText()+"';";
                PreparedStatement st = c14.c.prepareStatement(str2);
